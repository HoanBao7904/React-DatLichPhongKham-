...
import DateSelect from 'src/Page/Profile/DateSelect'
        ...
        <div className='md:col-span-9 lg:col-span-9'>
          <div className='rounded-2xl bg-white shadow-2xl overflow-hidden'>
            ...
            <div className='bg-gradient-to-r from-[#2D5A3D] to-[#FF6B6B] px-8 py-6'>
              <h1 className='text-2xl font-bold text-white'>Chỉnh Sửa Hồ Sơ Của bệnh nhân</h1>
            </div>
            ...
            <button
              ...
              className=' m-3 bg-gradient-to-r from-[#2D5A3D] to-[#FF6B6B] text-white font-semibold px-8 py-3 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2'
            >
              <span>Quay lại</span>
