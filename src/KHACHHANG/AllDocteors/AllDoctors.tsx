...
//   const { id } = useParams()
//   const [selectedDept, setSelectedDept] = useState<number | null>(Number(id) || null)
...
//     // Reset selected department khi search
...
//     if (keyword !== '') {
//       return `Tìm thấy ${displayData.length} kết quả cho từ khóa "${keyword}"`
//     }
...
//                 // Clear search khi chọn khoa
//                 navigate('/user/AllDoctor')
//               }}
//               className='px-6 py-3 bg-white border-2 border-blue-200 text-blue-700 rounded-xl hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 shadow-sm hover:shadow-md font-medium cursor-pointer'
//             >
//               <option value=''>Chọn chuyên khoa</option>
//               {allDepartment?.data.data?.map((d) => (
...
//             <button className='flex items-center gap-2 px-6 py-3 bg-white border-2 border-green-200 text-green-700 rounded-xl hover:bg-green-50 hover:border-green-300 transition-all duration-200 shadow-sm hover:shadow-md'>
