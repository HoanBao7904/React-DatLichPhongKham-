...
export default function ItemDoctor({ doctor }: Props) {
  ...
  // return (
  //   <div className='bg-white border border-gray-200 rounded-lg p-6 grid grid-cols-12 gap-6 items-center hover:shadow-md transition-all duration-200 hover:border-blue-200'>
  //     {/* Avatar */}
  ...
  //           />
  //         ) : (
  //           <div className='rounded-full w-20 h-20 bg-blue-100 border-2 border-blue-200 flex items-center justify-center'>
  ...
  //         {/* Badge trạng thái
  //         {!doctor.active && (
  //           <div className='absolute -top-1 -right-1 bg-red-500 text-white text-xs px-2 py-1 rounded-full'>Offline</div>
  //         )} */}
  //         {/* {doctor.isFeatured && (
  ...
  //         <h3 className='font-semibold text-xl text-gray-900'>{doctor.fullName}</h3>
  //         {doctor.isFeatured && (
  ...
  //       {/* Mô tả */}
  //       {doctor.description && <p className='text-gray-600 text-sm mb-3 line-clamp-2'>{doctor.description}</p>}
  ...
  //             />
  //           </svg>
  //           <span className=' max-w-[150px]'>{doctor.email}</span>
  //         </div>
  ...
  //               />
  //             </svg>
  //             <span>{doctor.specializations.length} chuyên môn</span>
  //           </div>
  //         )}
  //       </div>
  //     </div>
  ...
  //         type='button'
  //         className='bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md disabled:bg-gray-400 disabled:cursor-not-allowed'
