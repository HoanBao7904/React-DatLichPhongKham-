...
export default function Login() {
  ...
  // return (
  //   <div className='flex items-center justify-center min-h-screen bg-teal-300 rounded-[12px] w-full'>
  //     <div className='flex max-w-6xl  bg-white rounded-3xl overflow-hidden shadow-lg'>
  //       {/* Left side - Form */}
  ...
  //       <div className='hidden md:flex flex-1 bg-gradient-to-tr from-indigo-500 to-purple-500 justify-center items-center p-8'>
  //         <img src='/src/imgs/bacsi.png' alt='illustration' className='w-full h-full m-5 rounded-md' />
  //       </div>
  //     </div>
  //   </div>
  // )
