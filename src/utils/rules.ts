...
export const ProfileDoctor = yup.object({
  ...
  experienceYears: yup
    ...
    .required('kinh nghiệm không để trống'),
  description: yup.string().max(500, 'độ dài tối đa 500 kí tự').required(),
  departmentName: yup.string().max(200, 'độ dài tối đa 200 kí tự').required()
})
