...
// import type { AuthResponse, RegisterResponse } from 'src/types/auth.type'
...
//           //dây key truyền lên server với cái key headers và name phải là "Authorization"
//           return config
//         }
//         return config
//         // nếu có token gán nó về header return  không return bth
//       },
//       (error) => {
...
//           this.token = data.data!.token /// chỗ này
//           //còn profile
//           // Lưu profile vào localStorage hoặc context
...
//           toast.error(message)
//         }
//         return Promise.reject(error) //xu li loi ngoai lề
//       }
//     )
//   }
// }
